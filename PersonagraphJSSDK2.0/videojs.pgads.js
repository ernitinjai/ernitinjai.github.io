...
(function(vjs) {
  ...
  var PGAdsPlugin = function(player, options, readyCallback) {
    ...
    var createAdContainer_ = function() {
      ...
      assignControlAttributes_(this.adContainerDiv, 'pg-ad-container');
      ...
      this.adDisplayContainer =
          new pgads.AdDisplayContainer(this.adContainerDiv, this.contentPlayer);
