  ...
  adFramework = function(options) {
    ...
    (function() {
      ...
      player.on(videoEvents, function redispatch(event) {
       // alert(event.type);
        document.getElementById("pg-sample-console").innerHTML = document.getElementById("pg-sample-console").innerHTML + '<br/>' + 'event type '+ event.type ;
    ...
    fsmHandler = function(event) {
      ...
      (function(state) {
        ...
        if (state !== player.ads.state) {
          ...
          // output debug logging //todo: 
          if (settings.debug) {
            videojs.log('ads', player.ads.triggerevent + ' triggered: ' + state + ' -> ' + player.ads.state);
            document.getElementById("pg-sample-console").innerHTML = document.getElementById("pg-sample-console").innerHTML + '<br/>' + 'ads '+ player.ads.triggerevent + ' triggered: ' + state + ' -> ' + player.ads.state;
          }
        }
