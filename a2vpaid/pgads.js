...
pgads.AdsManager =  function(player){
	...
	this.player.on('seeking', function () {
		document.getElementById("pg-sample-console").innerHTML = document.getElementById("pg-sample-console").innerHTML + '<br/>' + 'event type seeking111' ;
		//adManagerObj.player.trigger("timeupdate");
